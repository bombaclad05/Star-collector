...
# =============================================================================
# MOVED BUTTON CLASS TO THIS POSITION (BEFORE ITS USAGE)
# =============================================================================
...
# Create buttons (NOW AFTER BUTTON CLASS DEFINITION)
...
# GitHub button (opens repository in browser)
github_button = Button(WIDTH - 120, HEIGHT - 60, 100, 40, "GitHub", 
                      lambda: webbrowser.open("https://github.com/yourusername/yourrepository"))
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if github_button.handle_event(event):
            continue
    ...
    # Always update GitHub button hover state
    github_button.check_hover(mouse_pos)
    ...
    # Draw GitHub button (always visible)
